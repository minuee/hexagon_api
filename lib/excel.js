...
const S3_BUCKET_NAME = "hg-prod-file";
...
async function sendCMSExcel(req, list, columns) {
    ...
    const full_path = `public/excel/${filename}.cms.xlsx`;
    // const local_filepath = os.path.join(
    //     tempfile.gettermpdir(),
    //     `${filename}`.cms.excel.xlsx
    // );
